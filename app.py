...
required_files = [
    ...
    'Model/predict_ipl_score_best_rf.pkl'  # Will be created by decompressing BZ2
]

missing_files = [f for f in required_files if not os.path.exists(f)]

if missing_files:
    st.info(f"⏳ Downloading and setting up {len(missing_files)} files... This will take 3-4 minutes.")
